#include "groupserver.h"
 void groupserver::handleCreateGroup(int fd, const json& req)
    {
    ...
    void groupserver::handleGetMyGroups(int fd, const json& req) 
    {
        string user = req["user"];
    ...
    void groupserver::handleDisbandGroup(int fd,const json& req)
    {
        string user=req["user"];
    ...
    void groupserver::handleLeaveGroup(int fd,const json& req)
    {
        string user = req["user"];
        int groupId = req["group_id"];
        unique_ptr<sql::Connection> con(mysql.getDBConnection());
    ...
    void groupserver::handleGetUserRole(int fd, const json& req)
    {
        int groupId = req["group_id"];
        string user = req["user"];
        unique_ptr<sql::Connection> con(mysql.getDBConnection());
    ...
    void groupserver::handleJoinGroupRequest(int fd, const json& req)
    {
        string user = req["user"];
        int groupId = req["group_id"];
    ...
    void groupserver::handleGetGroupJoinRequests(int fd, const json& req) 
    {
        int groupId = req["group_id"];
    ...
    void groupserver::handleProcessJoinRequest(int fd, const json& req)
    {
        int groupId = req["group_id"];
        string admin = req["admin"];
    ...
    void groupserver::handleGetGroupInfo(int fd, const json& req) 
    {
        int groupId = req["group_id"];
    ...
    void groupserver::handleAddGroupAdmin(int fd, const json& req)
    {
        int groupId = req["group_id"];
        string username = req["user"];
    ...
    void groupserver::handleRemoveGroupAdmin(int fd, const json& req)
    {
        int groupId = req["group_id"];
        string username = req["user"];
        string adminUsername = req["admin"]; // 操作者用户名
    ...
    void groupserver::handleRemoveGroupMember(int fd, const json& req)
    {
        int groupId = req["group_id"];
        string username = req["user"];
        string adminUsername = req["admin"]; // 操作者用户名
    ...
    void groupserver::handleAckGroupMessage(int client_sock, const json& data)
    {
